...
clique_Menu.onclick = function (e) { // isso abre o menuLateral
    ...
    confirmaTeclas() // preenche os inputs com as teclas atualmente configuradas
}
...
function verificaGanhador() {
    if (placarDireita >= pontuacaoFimDoJogo) {
        ...
        document.getElementById('btnFechaDivFinalPartida').focus()
...
// var teclaMaisEsquerda = 'w'
// var teclaMenosEsquerda = 's'
// var teclaMaisDireita = 'ArrowUp'
// var teclaMenosDireita = 'ArrowDown'

var teclaMaisEsquerda = localStorage.getItem('TECLAMAISESQUERDA')
var teclaMenosEsquerda = localStorage.getItem('TECLAMENOSESQUERDA')
var teclaMaisDireita = localStorage.getItem('TECLAMAISDIREITA')
var teclaMenosDireita = localStorage.getItem('TECLAMENOSDIREITA')

if(teclaMaisEsquerda == undefined) teclaMaisEsquerda = 'w'
if(teclaMenosEsquerda == undefined) teclaMenosEsquerda = 's'
if(teclaMaisDireita == undefined) teclaMaisDireita = 'ArrowUp'
if(teclaMenosDireita == undefined) teclaMenosDireita = 'ArrowDown'
...
function lerTeclas(evento)
{
    ...
    {
        if(evento.key == teclaMaisEsquerda) maisUmEsquerda()
        if(evento.key == teclaMenosEsquerda) menosUmEsquerda()
        if(evento.key == teclaMaisDireita) maisUmDireita()
        if(evento.key == teclaMenosDireita) menosUmDireita()
...
document.onkeyup = lerTeclas 

////////// configuração das teclas de comando

// 
document.getElementById('maisEsq').onkeyup = configuraTeclaMaisEsquerda
document.getElementById('menosEsq').onkeyup = configuraTeclaMenosEsquerda
document.getElementById('maisDir').onkeyup = configuraTeclaMaisDireita
document.getElementById('menosDir').onkeyup = configuraTeclaMenosDireita

function configuraTeclaMaisEsquerda(e)
{
    e.preventDefault()
    e.stopPropagation()
    if(teclaMenosEsquerda!=e.key && teclaMaisDireita!=e.key && teclaMenosDireita!=e.key)
    {
        teclaMaisEsquerda = e.key
    }else
    {
        alert(`Escolha outra tecla,    ${e.key}    já está em uso`)
    }
    confirmaTeclas()
    salvarPreferencias()
}
function configuraTeclaMenosEsquerda(e)
{
    e.preventDefault()
    e.stopPropagation()
    if(teclaMaisEsquerda!=e.key && teclaMenosEsquerda!=e.key && teclaMaisDireita!=e.key && teclaMenosDireita!=e.key)
    {
        teclaMenosEsquerda = e.key
    }else
    {
        alert(`Escolha outra tecla,    ${e.key}    já está em uso`)
    }
...
function configuraTeclaMaisDireita(e)
{
    e.preventDefault()
    e.stopPropagation()
    if(teclaMaisEsquerda!=e.key && teclaMenosEsquerda!=e.key && teclaMenosDireita!=e.key)
    {
        teclaMaisDireita = e.key
    }else
    {
        alert(`Escolha outra tecla,    ${e.key}    já está em uso`)
    }
...
function configuraTeclaMenosDireita(e)
{
    e.preventDefault()
    e.stopPropagation()
    if(teclaMaisEsquerda!=e.key && teclaMenosEsquerda!=e.key && teclaMaisDireita!=e.key)
    {
        teclaMenosDireita = e.key
    }else
    {
        alert(`Escolha outra tecla,    ${e.key}    já está em uso`)
    }
...
function confirmaTeclas()
{// escreve nos inputs de configuração as teclas atuais
    document.getElementById('maisEsq').value = teclaMaisEsquerda
    document.getElementById('menosEsq').value = teclaMenosEsquerda
    document.getElementById('maisDir').value = teclaMaisDireita
    document.getElementById('menosDir').value = teclaMenosDireita
}

// function escreveteclaNoInput(caixa, tecla)
// {
//     switch(tecla)
//     {
//         case ArrowUp: document.getElementById(caixa).value = 
//     }
// }
...
function salvarPreferencias()
{
    ...
    localStorage.setItem('TECLAMAISESQUERDA', teclaMaisEsquerda)
    localStorage.setItem('TECLAMENOSESQUERDA', teclaMenosEsquerda)
    localStorage.setItem('TECLAMAISDIREITA', teclaMaisDireita)
    localStorage.setItem('TECLAMENOSDIREITA', teclaMenosDireita)
}   